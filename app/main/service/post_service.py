...
class PostService:
    ...
    def get_post_by_query(query, page = 1):
        ...
        try:
            ...
            LOG.error("Couldn't fetch posts with query {}".format(query), exc_info=True)
            response_object = {
                'status' : 'fail',
    ...
    def create_new_post(post_data):
        try:
            ...
            post = Post(current_user_id, post_title, post_body)
            response_object = {
                'status' : 'success', 
            ...
            LOG.error("Couldn't create post with data {}".format(post_data), exc_info=True)
            response_object = {
                'status' : 'fail',
    ...
    def update_post(post_data, post_id):
        try:
            ...
            LOG.error("Couldn't update post with data {}".format(post_data), exc_info=True)
            response_object = {
                'status' : 'fail',
    ...
    def delete_post(data):
        try:
            ...
            LOG.error("Couldn't delete post with data {}".format(post_data), exc_info=True)
            response_object = {
                'status' : 'fail',
    ...
    def upvote_post(post_id):
        try:
            ...
            LOG.error("Couldn't upvote post with data {}".format(post_id), exc_info=True)
            response_object = {
                'status' : 'fail',
    ...
    def fetch_all_comments(post_id):
        try:
            ...
            LOG.error("Couldn't fetch comments for post with data {}".format(post_id), exc_info=True)
            response_object = {
                'status' : 'fail',
                'message' : 'Try later'
            }            
